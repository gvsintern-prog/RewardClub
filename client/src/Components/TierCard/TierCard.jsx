          ...
          <div className="relative group md:mt-0">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl hover:shadow-2xl transition-all duration-300 bg-gradient-to-br from-white to-Green/5 border-3 border-Green/50 transform md:scale-105">
              ...
              <div className="p-10">
                ...
                <a href="/tiers-benefits" className="block">
                  <button className="w-full group/btn relative bg-Green text-white py-3 px-6 rounded-xl font-bold text-base transition-all duration-300 hover:shadow-xl hover:shadow-Green/40 flex items-center justify-center gap-2">
                    <span>{t('learn_more') || 'Learn More'}</span>
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
